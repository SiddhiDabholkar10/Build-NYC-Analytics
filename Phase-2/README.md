...
- [Task 3: Interactive and Extended Vega-Lite Visualizations](#task-3--interactive-and-extended-vega-lite-visualizations)
  ...
  - [4) Spatial-Temporal Analysis](#4-visualization--clustered-bar-chart---monthly-filings-by-job-type)
...
####  4) *Visualization:- Clustered Bar Chart - Monthly Filings by Job Type*
